...
public class MyServer {
    ...
    public synchronized void privateMessage(String message, ClientHandler sender, String destinationUserName) throws IOException {
        for (ClientHandler client : clients) {
            if(client.getUsername() == destinationUserName) {
